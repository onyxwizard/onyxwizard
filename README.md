...
<table width="100%" cellpadding="10" cellspacing="0">
  <tr>
    <!-- GitHub Stats -->
    <td style="border:2px dashed red; padding:10px;" valign="top" width="50%">
      <div style="background:#111; padding:15px; border-radius:8px;">
        <h4 style="color:#00ffe1; text-align:center;">📊 GitHub Stats</h4>
        <img src="https://github-readme-stats.vercel.app/api?username=onyxwizard&theme=neon&hide_border=false&include_all_commits=false&count_private=false" width="100%" alt="GitHub Stats" />
      </div>
    </td>
    <!-- Streak Stats -->
    <td style="border:2px dashed red; padding:10px;" valign="top" width="50%">
      <div style="background:#111; padding:15px; border-radius:8px;"> 
        <h4 style="color:#00ffe1; text-align:center;">🔥 Git Streak</h4>
        <img src="https://nirzak-streak-stats.vercel.app/?user=onyxwizard&theme=neon&hide_border=false" width="100%" alt="Streak Stats" />
      </div>
    </td>
  </tr>
</table>
...
<table width="100%" cellpadding="10" cellspacing="0">
  <tr>
    <!-- Web Stack -->
    <td style="border:2px dashed red" valign="top" width="25%">
      <div style="background:#111;padding:15px;border-radius:8px;">
        <h4 style="color:#00ffe1;text-align:center;">🌐 Web Stack</h4>
    ...
    <td style="border:2px dashed red" valign="top" width="25%">
      <div style="background:#111;padding:15px;border-radius:8px;"> 
        <h4 style="color:#00ffe1;text-align:center;">🧱 Frameworks</h4>
    ...
    <!-- Cloud & Tools -->
    <td style="border:2px dashed red" valign="top" width="25%">
      <div style="background:#111;padding:15px;margin-top:10px;border-radius:8px;"> 
        <h4 style="color:#00ffe1;text-align:center;">☁️ Cloud & Tools</h4>
    ...
    <td style="border:2px dashed red" valign="top" width="25%">
      <div style="background:#111;padding:15px;margin-top:10px;border-radius:8px;"> 
        <h4 style="color:#00ffe1;text-align:center;">🎨 Design & APIs</h4>
...
<table width="100%" cellpadding="10" cellspacing="0">
  <tr>
    ...
    <td style="border:2px dashed red; padding:10px;" valign="top" width="50%">
      <div style="background:#111; padding:15px; border-radius:8px;">
        <h4 style="color:#00ffe1; text-align:center;">🏆 Top Contributed Repo</h4>
        <img src="https://github-contributor-stats.vercel.app/api?username=onyxwizard&limit=5&theme=neon&combine_all_yearly_contributions=true" width="100%" alt="Top Contributed Repo" />
      </div>
    </td>
    <!-- Top Languages -->
    <td style="border:2px dashed red; padding:10px;" valign="top" width="50%"> 
      <div style="background:#111; padding:15px; border-radius:8px;">   
        <h4 style="color:#00ffe1; text-align:center;">🔤 Top Languages</h4>
        <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=onyxwizard&theme=neon&hide_border=false&include_all_commits=false&count_private=false&layout=compact" width="100%" alt="Top Languages" />
      </div>
    </td>
  </tr>
</table>
